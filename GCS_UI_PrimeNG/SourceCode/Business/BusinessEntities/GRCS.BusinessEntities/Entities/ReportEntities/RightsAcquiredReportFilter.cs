 ...
 * Created on   :  7/5/2013
 * Description  :  To add filters in Rights Acquired reports
 * *************************************************************************** 
 ...
 *
******************************************************************************
 * Description :  Defines the entities for Rights Acquired Report Filter Fields
...
namespace UMGI.GRCS.BusinessEntities.Entities.ReportEntities
{
    ...
    [DataContract]
    [Serializable]
    public class RightsAcquiredReportFilter :Page
    {
           /// <summary>
        /// Initializes a new instance of the <see cref="Report Filter Fields"/> class.
        /// </summary>
        public RightsAcquiredReportFilter()
        {
