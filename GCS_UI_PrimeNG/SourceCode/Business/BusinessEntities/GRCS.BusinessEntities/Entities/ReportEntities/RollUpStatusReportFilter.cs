 ...
 * Created on   :  7/5/2013
 * Description  :  To add filters in RollUpStatus reports
 * *************************************************************************** 
 ...
 *
******************************************************************************
 * Description :  Defines the entities for RollUpStatus Filter Fields
...
namespace UMGI.GRCS.BusinessEntities.Entities.ReportEntities
{
    ...
    [DataContract]
    [Serializable]
   public  class RollUpStatusReportFilter : Page
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="Report Filter Fields"/> class.
        /// </summary>
        public RollUpStatusReportFilter()
        {
