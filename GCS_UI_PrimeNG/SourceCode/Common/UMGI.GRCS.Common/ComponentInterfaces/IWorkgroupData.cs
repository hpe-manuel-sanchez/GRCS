...
{
    public interface IWorkgroupData
    {
        ...
        List<Request> GetAllChildPendingRequest(RequestSearch requestSearch);
        ...
        List<WorkgroupBase> GetWorkgroupsByUser(long userId);
    }
}
