...
function GetMasterBreadcrumbs(masterFullPath, styleInfo, separator)
{
	...
	if(masterFullPath.indexOf("/GCS/mergedProjects/") == -1 &&
...
function getPPStartPagePath(sPath)
{
	if(sPath.length != 0)
	{
		...
		if(sXmlFolderPath.indexOf("/GCS/mergedProjects/") == -1 &&
...
function show()
{
	if(gbBadUriError)
	{
		...
		var indx = strMainPage.toLowerCase().indexOf("/GCS/mergedprojects/");
		if(indx != -1)
