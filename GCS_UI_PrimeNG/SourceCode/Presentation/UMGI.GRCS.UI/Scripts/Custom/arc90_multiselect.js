...
a$.multiSelectPrep = function (parent) {
    ...
    var P = a$.T('input', a$.e('a9multiselect-body-' + pid)), toObj = $(parent.id.slice('a9multiselect-'.length)), to = toObj.value, newto = '';
    ...
    if (to != '' && to != undefined) { // remove any duplicates when reloading with firefox
