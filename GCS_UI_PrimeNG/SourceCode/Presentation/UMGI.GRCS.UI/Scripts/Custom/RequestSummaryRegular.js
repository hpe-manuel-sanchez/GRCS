    ...
    $('#newResourcesList').jtable({
        ...
        recordsLoaded: function (event, data) {
            ...
            switch (data.serverResponse.RoutingStatus) {
                ...
                case 4: $('#newResourcesList').hide();
                    $('#divSearchRequestSummaryNewPaging').hide();
                    $('#errorMessageDiv').text(RoutingMessageWhenErrorIsInRouting);
                    $('#errorMessageDiv').show();
                    break;

                case 5: $('#newResourcesList').hide();
                    $('#divSearchRequestSummaryNewPaging').hide();
                    $('#errorMessageDiv').text("Cancellation is in progress");
                    $('#errorMessageDiv').show();
                    break;

                case 6: $('#newResourcesList').hide();
                    $('#divSearchRequestSummaryNewPaging').hide();
                    $('#errorMessageDiv').text("Completion is in progress");
                    $('#errorMessageDiv').show();
                    break;

                case 7: $('#newResourcesList').hide();
                    $('#divSearchRequestSummaryNewPaging').hide();
                    $('#errorMessageDiv').text("Reinstate is in progress");
                    $('#errorMessageDiv').show();
                    break;
...
function loadExisting() {
    ...
    $('#existingResourcesList').jtable({
        ...
        recordsLoaded: function (event, data) {
            $('#loaderMsg').hide();
            switch (data.serverResponse.RoutingStatus) {
                case 0: $('#existingResourcesList').hide();
                ...
                case 1: $('#existingResourcesList').hide();
                    $('#divSearchRequestSummaryExistingPaging').hide();
                    $('#errorMessageDiv').show();
                    $('#refreshBtnDiv').css('float', 'left');
                    $('#errorMessageDiv').text(RoutingMessageWhenReachedRouting);
                ...
                case 2: $('#existingResourcesList').hide();
                    $('#divSearchRequestSummaryExistingPaging').hide();
                    $('#errorMessageDiv').show();
                    $('#refreshBtnDiv').css('float', 'left');
                    $('#errorMessageDiv').text(RoutingMessageWhenReachedRouting);
                ...
                case 4: $('#existingResourcesList').hide();
                    $('#divSearchRequestSummaryExistingPaging').hide();
                    $('#errorMessageDiv').text(RoutingMessageWhenErrorIsInRouting);
                    $('#errorMessageDiv').show();
                    break;
...
function remindRequest(projReqId) {
    ...
    $.ajax({
        url: '/GCS/ClearanceProject/ActionOnRequest',
        type: 'POST',
        data: { RequesterWorkgroupId: requesterWorkgroupId, ClearanceProjectId: ClearanceProjectId, RequestId: RequestId, RoutedItemId: RoutedItemId, WorkgroupId: WorkGroupId, SequenceNo: Action, Comment: comments, ModifiedDateRequestString: ModifiedDatetimeRequest, ModifiedDateRoutedString: ModifiedDatetime },
        dataType: 'json',
        async: 'async',
        success: function (data) {
            $('#loadingDivPA').hide();
...
function LoadExistingReleaseTabSynchronously() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { clrprojectId: $('#Clr_Project_Id').val(), NeworExisting: $('#FlagReleaseNewOrExisting').val(), ActiveRoleGroup: _roleGroup },
        success: function (data) {
            if (data.Error) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ($('#IsResourceTabLoaded').val() == 'True') {
                //Making submit buttons enable after both tabs are loaded only
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ($('#IsReleaseTabLoaded').val() == 'True') {
                ...
                // enable disable PushToR2 button
                var digitalVal = $('#CreateRegularProjectForm').serialize();
                // call EnableDisblePushToR2Btn method
                $.post('/GCS/ClearanceProject/EnableDisblePushToR2Btn', digitalVal, function (data) {
