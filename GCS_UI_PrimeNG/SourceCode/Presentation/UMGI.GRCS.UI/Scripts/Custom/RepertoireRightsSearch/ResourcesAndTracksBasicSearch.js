...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#ResourcesAndTracksBasicSearchwaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//            '<b>Basic Search </b>'
//    );
    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights > > Show Resources & Tracks > > Basic Search");
    resizeHandler();
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                var gridObj = $find("ResourcesAndTracksBasicSearch");
...
//    $("#ResourcesAndTracksBasicSearch .MsgBar").empty();
//    $("#ResourcesAndTracksBasicSearch .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#ResourcesAndTracksBasicSearch .MsgBar").empty();
//    $("#ResourcesAndTracksBasicSearch .MsgBar").text("Search Results (" + totCount + ")");
//    $("#ResourcesAndTracksBasicSearch .manualPagerLabel:eq(1)").empty();
//    $("#ResourcesAndTracksBasicSearch .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#ResourcesAndTracksBasicSearch_Table");
...
//    var jtableTop = $("#ResourcesAndTracksBasicSearch").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#ResourcesAndTracksBasicSearch_Table").height() + reduceHgt;
...
//    $find("ResourcesAndTracksBasicSearch").sendRefreshRequest();
//}
...
//    $("#ResourcesAndTracksBasicSearch_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#ResourcesAndTracksBasicSearch").find(".GridHeader #chkAll");
...
//    var gridObj = $find("ResourcesAndTracksBasicSearch");
//    var checkboxes = $("#ResourcesAndTracksBasicSearch").find(".GridContent #chkChild");
