...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameterswaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//                '<b>Search Using Release Parameters</b>'
        //        );
        $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Digital Restrictions > > Show Resources & Tracks > > Search Using Release Parameters ");
        ...
        $('#btnSearchRepertoireRights').click(function (e) {
            ...
            if (!isValidationSuccess) {
                ...
                $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                    $find("DigitalRestrictionsResourcesAndTracksSearchReleaseParameters").sendRefreshRequest();
                });
                return true;
            }
            else {
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'DigitalRestrictionsResourcesAndTracksSearchReleaseParameters') {
...
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .MsgBar").text("Search Results (" + totCount + ")");
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .manualPagerLabel:eq(1)").empty();
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters_Table");
...
//    var jtableTop = $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters_Table").height() + reduceHgt;
//    var tableHeight = topfootPos - jtableTop;
//    var gridObj = $find("DigitalRestrictionsResourcesAndTracksSearchReleaseParameters");
...
//    $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters").find(".GridHeader #chkAll");
...
//    var gridObj = $find("DigitalRestrictionsResourcesAndTracksSearchReleaseParameters");
//    var checkboxes = $("#DigitalRestrictionsResourcesAndTracksSearchReleaseParameters").find(".GridContent #chkChild");
