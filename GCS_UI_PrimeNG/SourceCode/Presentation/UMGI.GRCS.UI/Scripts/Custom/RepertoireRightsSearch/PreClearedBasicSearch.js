...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#PreClearedBasicSearchwaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//            '<b>Basic Search </b>'
            ...
            $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Pre-Cleared > > Basic Search");
            ...
            $('#btnSearchRepertoireRights').click(function (e) {
                ...
                if (!isValidationSuccess) {
                    ...
                    $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                        var gridObj = $find("PreClearedBasicSearch");
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'PreClearedBasicSearch') {
...
//    $("#PreClearedBasicSearch .MsgBar").empty();
//    $("#PreClearedBasicSearch .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#PreClearedBasicSearch .MsgBar").empty();
//    $("#PreClearedBasicSearch .MsgBar").text("Search Results (" + totCount + ")");
//    $("#PreClearedBasicSearch .manualPagerLabel:eq(1)").empty();
//    $("#PreClearedBasicSearch .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#PreClearedBasicSearch_Table");
...
//    var jtableTop = $("#PreClearedBasicSearch").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#PreClearedBasicSearch_Table").height() + reduceHgt;
...
//    $find("PreClearedBasicSearch").sendRefreshRequest();
//}
...
//    $("#PreClearedBasicSearch_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#PreClearedBasicSearch").find(".GridHeader #chkAll");
...
//    var gridObj = $find("PreClearedBasicSearch");
//    var checkboxes = $("#PreClearedBasicSearch").find(".GridContent #chkChild");
