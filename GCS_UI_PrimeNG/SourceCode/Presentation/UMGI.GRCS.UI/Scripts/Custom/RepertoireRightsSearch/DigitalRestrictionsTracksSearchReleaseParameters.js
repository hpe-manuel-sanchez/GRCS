...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#DigitalRestrictionsTracksSearchReleaseParameterswaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//        );
    ...
    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Digital Restrictions > > Show Tracks > > Search Using Release Parameters ");
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                $find("DigitalRestrictionsTracksSearchReleaseParameters").sendRefreshRequest(); 
            });
            return true;
        }
        else {
...
function CheckSearchCriteria() {
    ...
    var physicalExploitationRights = $('#SearchCriteria_SearchRightsCriteria_IsDigitalExploitationRights')[0][physicalExploitationRightsIndex].text;
    ...
    if ($('#pageName').val() == 'DigitalRestrictionsTracksSearchReleaseParameters') {
...
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .MsgBar").empty();
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .MsgBar").empty();
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .MsgBar").text("Search Results (" + totCount + ")");
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .manualPagerLabel:eq(1)").empty();
//    $("#DigitalRestrictionsTracksSearchReleaseParameters .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#DigitalRestrictionsTracksSearchReleaseParameters_Table");
...
//    var jtableTop = $("#DigitalRestrictionsTracksSearchReleaseParameters").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#DigitalRestrictionsTracksSearchReleaseParameters_Table").height() + reduceHgt;
//    var tableHeight = topfootPos - jtableTop;
//    var gridObj = $find("DigitalRestrictionsTracksSearchReleaseParameters");
...
//    $("#DigitalRestrictionsTracksSearchReleaseParameters_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#DigitalRestrictionsTracksSearchReleaseParameters").find(".GridHeader #chkAll");
...
//    var gridObj = $find("DigitalRestrictionsTracksSearchReleaseParameters");
//    var checkboxes = $("#DigitalRestrictionsTracksSearchReleaseParameters").find(".GridContent #chkChild");
