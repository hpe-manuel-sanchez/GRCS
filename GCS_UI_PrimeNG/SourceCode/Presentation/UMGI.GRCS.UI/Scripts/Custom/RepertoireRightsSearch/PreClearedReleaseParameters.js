...
$(document).ready(function ($) {
    ...
    $(".StackedHeader th:nth-child(23)").attr('style', 'background-color: #CC99FF !important; padding: 4px !important; border: none;');
    $(".StackedHeader th:nth-child(24)").attr('style', 'background-color: #CC99FF !important; padding: 4px !important; border: none;');
    ...
    $(".HeaderBar th:gt(31)").attr('style', 'background-color: #ECD9FF !important');
...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#PreClearedReleaseParameterswaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//        '<a>Rights & Pre-Cleared </a>' +
//            '<label class="breadCrumbSeparator">>> </label>' +
//            '<b>Search Using Release Parameters</b>'
//    );

    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Pre-Cleared > > Search Using Release Parameters");
    ...
    // Table Colors
    $("table.preClearanceClass tr:even").css("background-color", "#FFFFFF");
    $("table.preClearanceClass tr:odd").css("background-color", "#F5F5F5");
...
//    });
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                var gridObj = $find("PreClearedReleaseParameters");
    ...
    $('#btnResetRepertoireRightsSearchCriteria').click(function (e) {
        ...
        if ($('#SearchCriteria_PreClearanceList_0__Type')[0] != undefined) {
            $('#SearchCriteria_PreClearanceList_0__IsPreclearance')[0].selectedIndex = 0;
            $('#SearchCriteria_PreClearanceList_1__IsPreclearance')[0].selectedIndex = 0;
            $('#SearchCriteria_PreClearanceList_2__IsPreclearance')[0].selectedIndex = 0;
            $('#SearchCriteria_PreClearanceList_3__IsPreclearance')[0].selectedIndex = 0;
            $('#SearchCriteria_PreClearanceList_4__IsPreclearance')[0].selectedIndex = 0;
            $('#SearchCriteria_PreClearanceList_5__IsPreclearance')[0].selectedIndex = 0;
        }
    });

    $('#SearchCriteria_SearchResourceReleaseCriteria_Isrc').change(function () {
...
function CheckSearchCriteria() {
    ...
    var preClearanceList0 = $('#SearchCriteria_PreClearanceList_0__IsPreclearance')[0].selectedIndex;
    var preClearanceList1 = $('#SearchCriteria_PreClearanceList_1__IsPreclearance')[0].selectedIndex;
    var preClearanceList2 = $('#SearchCriteria_PreClearanceList_2__IsPreclearance')[0].selectedIndex;
    var preClearanceList3 = $('#SearchCriteria_PreClearanceList_3__IsPreclearance')[0].selectedIndex;
    var preClearanceList4 = $('#SearchCriteria_PreClearanceList_4__IsPreclearance')[0].selectedIndex;
    var preClearanceList5 = $('#SearchCriteria_PreClearanceList_5__IsPreclearance')[0].selectedIndex;

    if ($('#pageName').val() == 'PreClearedReleaseParameters') {
...
function ResouceSearchBeforeDrop(sender, args) {
    if ((args.From <= 20 && args.To >= 21) || (args.From >= 21 && args.To <= 20) ||
        (args.From >= 32 && args.To >= 21 && args.To <= 31) ||
        (args.From >= 21 && args.From <= 31 && args.To >= 32)
    ) {
...
//    $("#PreClearedReleaseParameters .MsgBar").empty();
//    $("#PreClearedReleaseParameters .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#PreClearedReleaseParameters .MsgBar").empty();
//    $("#PreClearedReleaseParameters .MsgBar").text("Search Results (" + totCount + ")");
//    $("#PreClearedReleaseParameters .manualPagerLabel:eq(1)").empty();
//    $("#PreClearedReleaseParameters .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#PreClearedReleaseParameters_Table");
...
//    var jtableTop = $("#PreClearedReleaseParameters").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#PreClearedReleaseParameters_Table").height() + reduceHgt;
...
//    $find("PreClearedReleaseParameters").sendRefreshRequest();
//}
...
//    $("#PreClearedReleaseParameters_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#PreClearedReleaseParameters").find(".GridHeader #chkAll");
...
//    var gridObj = $find("PreClearedReleaseParameters");
//    var checkboxes = $("#PreClearedReleaseParameters").find(".GridContent #chkChild");
