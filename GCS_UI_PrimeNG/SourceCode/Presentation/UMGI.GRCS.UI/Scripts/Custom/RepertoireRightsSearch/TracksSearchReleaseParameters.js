...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#TracksSearchReleaseParameterswaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//    );
    ...
    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights > > Show Tracks > > Search Using Release Parameters");
   ...
   $("#SearchCriteria_SearchResourceReleaseCriteria_Upc, #SearchCriteria_SearchResourceReleaseCriteria_ArtistName, #SearchCriteria_SearchResourceReleaseCriteria_ReleaseTitle").keypress(function (e) {
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            var pageName = $('#pageName').val();
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                var gridObj = $find("TracksSearchReleaseParameters");
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'TracksSearchReleaseParameters') {
...
//    $("#TracksSearchReleaseParameters .MsgBar").empty();
//    $("#TracksSearchReleaseParameters .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#TracksSearchReleaseParameters .MsgBar").empty();
//    $("#TracksSearchReleaseParameters .MsgBar").text("Search Results (" + totCount + ")");
//    $("#TracksSearchReleaseParameters .manualPagerLabel:eq(1)").empty();
//    $("#TracksSearchReleaseParameters .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#TracksSearchReleaseParameters_Table");
...
//    var jtableTop = $("#TracksSearchReleaseParameters").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#TracksSearchReleaseParameters_Table").height() + reduceHgt;
...
//    $find("TracksSearchReleaseParameters").sendRefreshRequest();
//}
...
//    $("#TracksSearchReleaseParameters_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#TracksSearchReleaseParameters").find(".GridHeader #chkAll");
...
//    var gridObj = $find("TracksSearchReleaseParameters");
//    var checkboxes = $("#TracksSearchReleaseParameters").find(".GridContent #chkChild");
