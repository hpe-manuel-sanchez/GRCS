...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#DigitalRestrictionsTracksBasicSearchwaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//        );
    ...
    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Digital Restrictions > > Show Tracks > > Basic Search ");
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                $find("DigitalRestrictionsTracksBasicSearch").sendRefreshRequest();
            });
            return true;
        }
        else {
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'DigitalRestrictionsTracksBasicSearch') {
...
//    $("#DigitalRestrictionsTracksBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsTracksBasicSearch .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#DigitalRestrictionsTracksBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsTracksBasicSearch .MsgBar").text("Search Results (" + totCount + ")");
//    $("#DigitalRestrictionsTracksBasicSearch .manualPagerLabel:eq(1)").empty();
//    $("#DigitalRestrictionsTracksBasicSearch .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#DigitalRestrictionsTracksBasicSearch_Table");
...
//    var jtableTop = $("#DigitalRestrictionsTracksBasicSearch").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#DigitalRestrictionsTracksBasicSearch_Table").height() + reduceHgt;
//    var tableHeight = topfootPos - jtableTop;
//    var gridObj = $find("DigitalRestrictionsTracksBasicSearch");
...
//    $("#DigitalRestrictionsTracksBasicSearch_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#DigitalRestrictionsTracksBasicSearch").find(".GridHeader #chkAll");
...
//    var gridObj = $find("DigitalRestrictionsTracksBasicSearch");
//    var checkboxes = $("#DigitalRestrictionsTracksBasicSearch").find(".GridContent #chkChild");
