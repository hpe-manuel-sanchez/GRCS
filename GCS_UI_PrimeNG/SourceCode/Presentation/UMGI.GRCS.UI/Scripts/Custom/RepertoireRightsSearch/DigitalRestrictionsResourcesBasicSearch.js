...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#DigitalRestrictionsResourcesBasicSearchwaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//                '<b>Basic Search </b>'
        ...
        $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Digital Restrictions > > Show Resources > > Basic Search ");
        ...
        $('#btnSearchRepertoireRights').click(function (e) {
            ...
            if (!isValidationSuccess) {
                ...
                $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                    $find("DigitalRestrictionsResourcesBasicSearch").sendRefreshRequest();
                });
                return true;
            }
            else {
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'DigitalRestrictionsResourcesBasicSearch') {
...
//    $("#DigitalRestrictionsResourcesBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesBasicSearch .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#DigitalRestrictionsResourcesBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesBasicSearch .MsgBar").text("Search Results (" + totCount + ")");
//    $("#DigitalRestrictionsResourcesBasicSearch .manualPagerLabel:eq(1)").empty();
//    $("#DigitalRestrictionsResourcesBasicSearch .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#DigitalRestrictionsResourcesBasicSearch_Table");
...
//    var jtableTop = $("#DigitalRestrictionsResourcesBasicSearch").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#DigitalRestrictionsResourcesBasicSearch_Table").height() + reduceHgt;
//    var tableHeight = topfootPos - jtableTop;
//    var gridObj = $find("DigitalRestrictionsResourcesBasicSearch");
...
//    $("#DigitalRestrictionsResourcesBasicSearch_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#DigitalRestrictionsResourcesBasicSearch").find(".GridHeader #chkAll");
...
//    var gridObj = $find("DigitalRestrictionsResourcesBasicSearch");
//    var checkboxes = $("#DigitalRestrictionsResourcesBasicSearch").find(".GridContent #chkChild");
