...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#ResourcesReleaseParameterswaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//    );
    ...
    $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights > > Show Resources > > Search Using Release Parameters ");
    ...
    $('#btnSearchRepertoireRights').click(function (e) {
        ...
        if (!isValidationSuccess) {
            ...
            $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                var gridObj = $find("ResourcesReleaseParameters");
...
function CheckSearchCriteria() {
    ...
    if ($('#pageName').val() == 'ResourcesReleaseParameters') {
        return ((upc == "" || upc == null)
...
//    $("#ResourcesReleaseParameters .MsgBar").empty();
//    $("#ResourcesReleaseParameters .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#ResourcesReleaseParameters .MsgBar").empty();
//    $("#ResourcesReleaseParameters .MsgBar").text("Search Results (" + totCount + ")");
//    $("#ResourcesReleaseParameters .manualPagerLabel:eq(1)").empty();
//    $("#ResourcesReleaseParameters .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#ResourcesReleaseParameters_Table");
...
//    var jtableTop = $("#ResourcesReleaseParameters").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#ResourcesReleaseParameters_Table").height() + reduceHgt;
...
//    $find("ResourcesReleaseParameters").sendRefreshRequest();
//}
...
//    $("#ResourcesReleaseParameters_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#ResourcesReleaseParameters").find(".GridHeader #chkAll");
...
//    var gridObj = $find("ResourcesReleaseParameters");
//    var checkboxes = $("#ResourcesReleaseParameters").find(".GridContent #chkChild");
