...
var objDialog = $('<div></div>')
    ...
    $(document).ready(function ($) {
        ...
        $(".StackedHeader th:nth-child(23)").attr('style', 'background-color: #ffdc25 !important; padding: 4px !important;');

        $(".HeaderBar th:lt(23)").attr('style', 'background-color: #B8D0E9 !important');
        $(".HeaderBar th:lt(25):gt(20)").attr('style', 'background-color: #c2e0f5 !important');
        $(".HeaderBar th:gt(24)").attr('style', 'background-color: #fcf190 !important');
...
//            HideWarningSuccess();
//            $('#loadingDiv').show();
//            if ($("#DigitalRestrictionsResourcesAndTracksBasicSearchwaiting_WaitingPopup_Image").is(":visible") == true)
//                $('#loadingDiv').hide();
//        });
...
//                '<b>Basic Search </b>'
//        );
        $('.gr_breadCrumbNav').html("Repertoire Rights Search > > Rights & Digital Restrictions > > Show Resources & Tracks > > Basic Search ");
        ...
        function resizeHandler() {
            var wid = $(".rrs #SearchCriteria_SearchResourceReleaseCriteria_ResourceTrackTitle").width();
...
//    $("#SearchCriteria_SearchResourceReleaseCriteria_Isrc, #SearchCriteria_SearchResourceReleaseCriteria_ArtistName, #SearchCriteria_SearchResourceReleaseCriteria_ResourceTrackTitle").keypress(function (e) {
...
//    });
    ...
    $("#SearchCriteria_SearchResourceReleaseCriteria_Isrc, #SearchCriteria_SearchResourceReleaseCriteria_ArtistName, #SearchCriteria_SearchResourceReleaseCriteria_ResourceTrackTitle").keypress(function (e) {
        ...
        $('#btnSearchRepertoireRights').click(function (e) {
            ...
            if (!isValidationSuccess) {
                ...
                $.post('/GCS/RepertoireRightsSearch/PopulateSearchCriteria', model, function () {
                    $find("DigitalRestrictionsResourcesAndTracksBasicSearch").sendRefreshRequest();
                });
                return true;
            }
            else {
        ...
        $('#btnResetRepertoireRightsSearchCriteria').click(function (e) {
            ...
            $('#SearchCriteria_SearchResourceReleaseCriteria_ResourceTrackTitle').val('');
...
function CheckSearchCriteria() {
    ...
    var resourceTitle = $('#SearchCriteria_SearchResourceReleaseCriteria_ResourceTrackTitle').val();
    ...
    if ($('#pageName').val() == 'DigitalRestrictionsResourcesAndTracksBasicSearch') {
...
function DigRestRowDataBound(sender, args) {
    ...
    var isSample = args.Element.children[18];
    ...
    var reviewStatus = args.Element.children[20];
...
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .MsgBar").text("Search Results (0)");
...
//    $('#warning').hide();
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .MsgBar").empty();
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .MsgBar").text("Search Results (" + totCount + ")");
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .manualPagerLabel:eq(1)").empty();
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch .manualPagerLabel:eq(1)").text("Show item per page");
//}
...
//    setSyncGridToolTip("#DigitalRestrictionsResourcesAndTracksBasicSearch_Table");
...
//    var jtableTop = $("#DigitalRestrictionsResourcesAndTracksBasicSearch").offset().top;
//    var topfootPos = $(".footer").offset().top;
//    var totRecHeight = $("#DigitalRestrictionsResourcesAndTracksBasicSearch_Table").height() + reduceHgt;
//    var tableHeight = topfootPos - jtableTop;
//    var gridObj = $find("DigitalRestrictionsResourcesAndTracksBasicSearch");
...
//    $("#DigitalRestrictionsResourcesAndTracksBasicSearch_Table").bind("click", function (event) {
//        HideWarningSuccess();
...
//    var obj = $("#DigitalRestrictionsResourcesAndTracksBasicSearch").find(".GridHeader #chkAll");
...
//    var gridObj = $find("DigitalRestrictionsResourcesAndTracksBasicSearch");
//    var checkboxes = $("#DigitalRestrictionsResourcesAndTracksBasicSearch").find(".GridContent #chkChild");
