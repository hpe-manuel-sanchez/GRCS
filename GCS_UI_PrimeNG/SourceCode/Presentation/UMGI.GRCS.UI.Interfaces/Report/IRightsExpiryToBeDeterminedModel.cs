 ...
 * *************************************************************************** 
 * File Name      : IRightsExpiryToBeDeterminedModel.cs
...
{
    public interface IRightsExpiryToBeDeterminedModel
    {
        /// <summary>
        ...
        /// </summary>
        List<IRightsExpiryToBeDeterminedModel> RightsExpiryToBeDeterminedContracts { get; set; }
