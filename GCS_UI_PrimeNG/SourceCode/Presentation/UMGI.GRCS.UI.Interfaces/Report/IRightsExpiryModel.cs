 ...
 * *************************************************************************** 
 * File Name      : IRightsExpiryModel.cs
...
{
    public interface IRightsExpiryModel
    {
        /// <summary>
        ...
        /// </summary>
        List<IRightsExpiryModel> RightsExpiryContracts { get; set; }

        /// <summary>
        /// Gets or sets the LostRightDateList
        /// </summary>
        IEnumerable<SelectListItem> LostRightDateList { get; set; }
